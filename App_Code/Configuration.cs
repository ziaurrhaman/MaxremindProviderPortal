...
namespace PayPalIntegration
{
	...
	public class WebConfiguration
	{
        ...
        public string AccountEmail = "mag2@gmail.com";
		public  string PayPalUrl = "https://www.sandbox.paypal.com/cgi-bin/webscr?";
		...
		/// </summary>
		public string CCPayPalUrl = "https://www.sandbox.paypal.com/cgi-bin/webscr?";

		/// <summary>
		/// The Email Address for the account to distribute money to.
		/// </summary>
        public string CCPayPalEmail = "mag2@gmail.com";
