...
/// <summary>
/// Summary description for adminCalendar
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
[System.Web.Script.Services.ScriptService]
public class adminCalendar : System.Web.Services.WebService
{
    ...
    */
    ...
    [WebMethod(EnableSession = true)]
    public AppointmentDataSource LoadAppointments(string app_date, string loc_id, string prov_id, string day, int UsersLength)
    {
        if (string.IsNullOrEmpty(prov_id))
        {
            PracticeStaffDB objPracticeStaffDB = new PracticeStaffDB();
...
{
    public string srv_provider_id { get; set; }
    public string srv_provider_name { get; set; }
}

public class AdminServicesData
{
