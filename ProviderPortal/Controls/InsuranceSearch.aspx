<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InsuranceSearch.aspx.cs" Inherits="EMR_Controls_InsuranceSearch" %>
      ...
      ###StartInsuranceSearch###
                ...
                <table>
                    ...
                    <tbody id="ShowInsuranceResult">
                        <asp:Repeater ID="rptInsurance" runat="server">
                            <ItemTemplate>
                                <tr style="cursor: pointer" onclick="GetInsuranceName(this)">
                                    <td>
                                        <i>
                                            <%# Eval("RowNumber") %></i>
                                    </td>
                            ...
                            <AlternatingItemTemplate>
                                <tr style="cursor: pointer" class="alternatingRow" onclick="GetInsuranceName(this)">
                                    <td>
                                        <i>
                                            <%# Eval("RowNumber") %></i>
                                    </td>
        ...
        <script type="text/javascript">
            function AddNewInsurance() {
                ...
                $.post(_ControlPath + "/CallBacks/AddEditInsuranceHandler.aspx", { Insurance: JSON.stringify(Insurance), Address: JSON.stringify(Address) }, function (data) {
            ...
            function FilterInsurance(pageNumber, paging) {
                ...
                $.post("../../ProviderPortal/Controls/InsuranceSearchHandler.aspx", { Name: Name, City: City, State: State, Zip: Zip, Rows: $("#ddlPagingInsurance").val(), pageNumber: pageNumber, SortBy: "" }, function (data) {
                    var returnHtml = data;
