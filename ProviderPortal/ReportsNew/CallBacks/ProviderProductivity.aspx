<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProviderProductivity.aspx.cs" Inherits="ProviderPortal_ReportsNew_CallBacks_ProviderProductivity" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="Filter SearchCriteria">
            ...
            <div class="row">
                ...
                <div class="col-3" style="margin-top: 36px;">
                    <div>
                        <input class='btn primary' type="button" title="Filter" value="Filter" id="FilterReports" onclick="FilterProviderProductivity(this)" />

                        <input class='btn primary' type="button" title="Customize Filter" value="Customize Report" id="CustomieReport" onclick="CustomizeProviderProductivity(this)" />
                ...
                <HeaderTemplate>
                    <div class="GridReports" id="printableArea">
                        <table>
                            ...
                            <tbody id="tbodyReportList" class="tbodyProviderCollection Providerproductivity">
                </HeaderTemplate>
                <ItemTemplate>
                    <tr>
                        <td class="center"><%# Container.ItemIndex + 1 %></td>
                        <td class='AlignString tdAttendingPhysician' <%--onclick="ProvidersClaimDetail(<%# Eval("Provider")%>)"--%>>
                            <%# Eval("Provider")%>
                        </td>
        ...
        <%--Added by Faiza Bilal 2-16-2022--%>

        <div style="display: none; padding: 20px;" id="CustomizeProviderProductivity">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 SelectDates" style="padding-bottom: 5px;">
                    <label style=""><b style="color: black">From:</b></label>
                    <span>
        ...
        <asp:Repeater runat="server" ID="RptFilterProviderCollectionReport">
            <ItemTemplate>
                <tr>
                    <td class="center"><%# Container.ItemIndex + 1 %></td>
                    <td class='AlignString tdAttendingPhysician' <%--onclick="ProviderWiseDetail(<%# Eval("Provider")%>)"--%>>
                        <%# Eval("Provider")%>
                    </td>
                    <td class="AlignDate AlignPayment">
                        <%# Convert.ToString(Eval("PatientCount"))==""?"0":Eval("PatientCount")%>
