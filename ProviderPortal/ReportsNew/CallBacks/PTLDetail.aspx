<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="PTLDetail.aspx.cs" Inherits="ProviderPortal_ReportsNew_CallBacks_PTLDetail" %>
...
<body>
    ...
    <div class="Filter SearchCriteria">
        <div class="row">
            ...
            <div class="col-lg-3" style="margin-top: 6px !important;">
                <div>
                    <input class='btn primary' type="button" title="Filter" value="Filter" id="FilterReports" onclick="FilterPTLPatientReport()" />
                    <input class='btn primary' type="button" title="Customize" value="Customize Report" id="CustomizeReports" onclick="CustomizePTLPatientReport()" />
    ...
    <div class=" ReportGridPrint GridReports">
        ...
        <table class="fixTable width_100 b_bottom" id="rptptlAll">
            <thead>
                <tr>
                    <th style="width: 2%;">#</th>
                    <th>Patient ID</th>
...
<%--                    <th>QA Approved</th>
                    ...
                    <th>Comm Count</th>
                    <th>Last Com Date</th>
                    <%--///Modified By Irfan Mahmood 25/Jan/2022--%>
                    ...
                    <%--///End Modified By Irfan Mahmood 25/Jan/2022--%>
                </tr>
            </thead>
...
<%--                            <td class="tdPTLType" style="display: none">
                                <asp:Label runat="server" ID="lblPTLType"></asp:Label>
                            </td>--%>
<%--                            <td style="display: none" class="ReportShow">
    ...
    <div id="CustomizePtlPatientReport" style="display: none; padding: 20px;">
        <div class="row">
           <div class="col-lg-3 SelectDateType">
                                ...
                                <div id="divPracticeLocation" class="div-multi-checkboxes-wrapper" style="display: none; max-height: 215px; padding: 0; top: 27px; left: 0; width: 99%;">
                                    <div class="ddlselect">
                                        <ul id="ulMultiPracticeLocation" onchange="GetServiceProviderDropDown();">
                                            ...
                                            <asp:Repeater runat="server" ID="rptLocationForPatient">
                                                <ItemTemplate>
                                                    <li style="float: left; width: 100%;">
