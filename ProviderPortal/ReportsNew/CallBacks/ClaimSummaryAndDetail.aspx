<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClaimSummaryAndDetail.aspx.cs" Inherits="EMR_ReportsNew_CallBacks_ClaimsDetailReport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="Filter SearchCriteria">
            ...
            <div class="row">
                ...
                <div class="col-lg-3" style="margin-top: 6px !important;">
                    <div>
                        <input class='btn primary' type="button" title="Filter" value="Filter" id="FilterReports" onclick="FilterClaimSummaryAndDetail()" />
                        <input class='btn primary' type="button" title="Customize" value="CustomizeReport" id="CustomizeReport" onclick="CustomizeClaimSummaryAndDetail()" />
                ...
                <thead>
                    <tr>
                        ...
                        <th class="center" style="width: 12%">
                            <span class="report-column-title">Charged Claim</span>
                        </th>
                        <th class="center" style="width: 7%">
                            <span class="report-column-title">Paid Claim</span>
                        </th>
                        <th class="center" style="width: 11%">
                            <span class="report-column-title">Unpaid Claim</span>
                        </th>
                        <th class="center" style="width: 11%">
                            <span class="report-column-title">Adj Claim</span>
                        </th>
                        ...
                        <th class="center" style="width: 7%">
                            <span class="report-column-title">Adj CPT</span>
                        </th>
                    </tr>
                </thead>
                <tbody id="tbodyReportList" class="ClaimSummmaryAndDetails">
                    <asp:Repeater ID="rptReportData" runat="server">
                        <ItemTemplate>
                            <tr>

                                <td class="AlignDate linkClass" onclick="claimDetail('CLM', '')">
                                    <%--<%# Eval("chargedclm")%>--%>
                                    <%# Convert.ToString(Eval("chargedclm"))==""?"0":Eval("chargedclm")%>
                                </td>
                                <td class="AlignDate linkClass" onclick="claimDetail('CLM', 'P')">
                                    <%--<%# Eval("paidclm")%>--%>
                                    <%# Convert.ToString(Eval("paidclm"))==""?"0":Eval("paidclm")%>
                                </td>
                                <td class="AlignDate linkClass" onclick="claimDetail('CLM', 'U')">
                                    <%--<%# Eval("unpaidclm")%>--%>
                                    <%# Convert.ToString(Eval("unpaidclm"))==""?"0":Eval("unpaidclm")%>
                                </td>
                                <td class="AlignDate linkClass" onclick="claimDetail('CLM', 'A')">
                                                        <%# Eval("adjclm")%>
                                                    </td>
                                <td class="AlignDate linkClass" onclick="claimDetail('', '')">
                                    <%--<%# Eval("chargedproc")%>--%>
                                    <%# Convert.ToString(Eval("chargedproc"))==""?"0":Eval("chargedproc")%>
                                </td>
                                <td class="AlignDate linkClass" onclick="claimDetail('', 'P')">
                                    <%--<%# Eval("paidproc")%>--%>
                                    <%# Convert.ToString(Eval("paidproc"))==""?"0":Eval("paidproc")%>
                                </td>
                                <td class="AlignDate linkClass" onclick="claimDetail('', 'U')">
                                    <%--<%# Eval("unpaidproc")%>--%>
                                    <%# Convert.ToString(Eval("unpaidproc"))==""?"0":Eval("unpaidproc")%>
                                </td>
                                <td class="AlignDate linkClass" onclick="claimDetail('', 'A')">
                                                        <%# Eval("adjproc")%>
                                                    </td>
                            </tr>
                        </ItemTemplate>
        ...
        <%--Edited by Faiza Bilal 3-30-2022--%>
        ...
        <input type="hidden" id="hdnpayername" runat="server" />

        <div class="dialogueClaim" style="display: none"></div>
        <%--End Edited by Faiza Bilal 3-30-2022--%>
        <%--/// Modified By Irfan Mahmood 11/Feb/2022--%>

        <div id="CustomizeClaimSummaryAndDetail" style="display: none; padding: 20px;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="divBranchName DivBrName">
                            ...
                            <div class="clsPostDate BranceInput" id="divddlGroupBy" onchange="EnableDisableGroup('ClaimSummary', this);">
                                                ...
                                                <ul id="ClaimSummaryLocations">
                                                    <li style="float: left; width: 100%;">
                                                        <label class="lbl-multi-checkboxes" style="float: left;">
                                                            <input type="checkbox" id="chkClaimSummaryLocationsAll" class="chk-multi-checkboxes-all" onclick="Report_ClickMultiCheckBoxAll(this,'ClaimSummaryLocations'),GetPracticeStaffLocation('ClaimSummaryLocations')" />
                                                            <span>All</span>
                                                        ...
                                                        <ItemTemplate>
                                                            <li style="float: left; width: 100%;">
                                                                <label style="float: left;">
                                                                    <input type="checkbox" class="chk-multi-checkboxes ClaimSummaryLocations" id="chkClaimSummaryLocations" onclick="ReportAlert(this,'ClaimSummaryLocations'),GetPracticeStaffLocation('ClaimSummaryLocations')" value='<%#Eval("PracticeLocationsId") %>' />
                                                                    <span><%#Eval("Name") %></span>
                    ...
                    <div class="col-4">
                        <div class="divBranchName ClaimStatus SelfPayHide" id="ClaimIds">
                            ...
                            <div class="BranceInput">
                                ...
                                <div class="MultipleClaimGridHere" style="position:relative;">
                                    <div id="divAllClaimsDropDownReport" style="display: none; position: absolute; max-height: 250px; width:100%; overflow-y: auto; background: #fff; border: 1px solid lightgray; z-index: 1;">
                                        <div class="Grid">
                                            <table>
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Status
                                                            <span style="float: right; margin-right: 17px; margin-top: -6px; cursor: pointer;" onclick="MultipleClaimGridHereClose(this)">
        ...
        <input type="hidden" id="hdnFilterStartDate" runat="server" value="" />
        <input type="hidden" id="hdnFilterEndDate" runat="server" value="" />
        <input type="hidden" id="hdnFilterDateType" runat="server" value="" />
        <input type="hidden"  runat="server" value="" id="hdnCPTS"/>
