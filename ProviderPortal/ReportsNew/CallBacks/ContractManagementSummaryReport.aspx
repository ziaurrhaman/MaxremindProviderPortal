<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractManagementSummaryReport.aspx.cs" Inherits="EMR_ReportsNew_CallBacks_ContractManagementSummaryReport" %>
...
<body>
    <form id="form1" runat="server">
        <div>
             ...
             <div class="Filter SearchCriteria">
                 <div class="row">
                     ...
                     <div class="col-lg-3" style="margin-top: 6px !important;">
                         <div>
                             <input class='btn primary' type="button" title="Filter" value="Filter" id="FilterReports" onclick="FilterContractManagementSummaryReport()" />
                             <input class='btn primary' type="button" title="Customize" value="Customize Report" id="CustomizeReports" onclick="CustomizeContractManagementSummaryReport()" />
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="asc" onclick="SortReportList(this,'Procedure');" style="width: 45% ;white-space:normal !important;">
                    ...
                    <tr class="BtmToatlTr">
                        ...
                        <td style="border-left: none; border-top: 1px solid #C4C4C4; font-weight: bold; float: right; width: 100%;">Total
                            <asp:Label ID="lblPracticeName" runat="server"></asp:Label></td>
                        <td style="border-top: 1px solid #C4C4C4;" id="AllowedAmount">
                            <asp:Label ID="lblTotalAllowedAmount" runat="server"></asp:Label></td>
                        <td style="border-top: 1px solid #C4C4C4;" id="AVGPayment">
                            <asp:Label ID="lblTotalAVGPayment" runat="server"></asp:Label></td>
                    </tr>
            ...
            <div id="CustomizeContractManagementSummaryReport" style="display: none; padding: 20px;">
                <div class="row">
                    <div class="col-lg-3 SelectDateType">
                        <div class="" id="divReportFilterBy">
                            <div id="divPostType" style="padding-bottom: 45px;">
