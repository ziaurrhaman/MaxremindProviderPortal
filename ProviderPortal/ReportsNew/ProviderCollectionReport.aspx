<%@ Page Title="" Language="C#" MasterPageFile="~/ProviderPortal/BillingMaster.master" AutoEventWireup="true" CodeFile="ProviderCollectionReport.aspx.cs" Inherits="ProviderPortal_ReportsNew_ProviderCollectionReport" %>
                                        ...
                                        <thead>
                                            <tr>
                                                <th style="text-align: center !important; background-color: rgb(79, 175, 216); position: relative; top: 0px;">
                                                    <span class="report-column-title">PatientName</span>
                                                </th>
