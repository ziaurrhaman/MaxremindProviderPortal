...
public partial class EMR_ReportsNew_filter_FilterPatientBalanceDetailReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet dsReportData = objPatientReportsDB.dsPatientBalanceDetail(PracticeId, Rows, PageNumber, SortBy, PatientIds, ProcedureCode, CustomDate, AsOf);
        ...
        //hdnPatientId.Value = Request.Form["PatientIds"];
