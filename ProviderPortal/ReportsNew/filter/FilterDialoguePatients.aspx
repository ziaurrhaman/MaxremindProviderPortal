<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FilterDialoguePatients.aspx.cs" Inherits="EMR_ReportsNew_filter_FilterDialoguePatients" %>
        ...
        <style type="text/css">
            ...
            <script type="text/javascript">
                ...
                function LCD_OpenForm(elem, Type, CallFrom) {
                    ...
                    if (Type == "DX") {
                        PagePath = "../../EMR/Controls/LCDDiagnosis.aspx";
                        ...
                        PagePath = "../../EMR/Controls/LCDProcedure.aspx";
            ...
            <div id="divDialogReportFilterBoxInner" style="">
                <div class="divDialogReportFilterBoxInnerHeader">
                    ...
                    <div class="divReportName" id="PatientContactList" runat="server" style="display: none;">
                        Patient Contact List
                    </div>
                    <div class="divReportName" id="divPatientDetail" runat="server" style="display: none;">
                        Patient Detail
                    </div>
                    <div class="divReportName" id="divPatientSummary" runat="server" style="display: none;">
                        Patient Summary
                    </div>
                    <div class="divReportName" id="divPatientBalanceDetaily" runat="server" style="display: none;">
                        Patient Balance Detail
                    </div>
                    <div class="divReportName" id="divPatientBalanceSummary" runat="server" style="display: none;">
                        Patient Balance Summary
                    </div>
                    <div class="divReportName" id="divPatientTransactionsSummary" runat="server" style="display: none;">
                        Patient Transactions Summary
                    </div>
                    <div class="divReportName" id="divAdjustmentsDetail" runat="server" style="display: none;">
                        Adjustments Detail
                    </div>
                    <div class="divReportName" id="divAdjustmentsSummary" runat="server" style="display: none;">
                        Adjustments Summary
                    </div>
                    <div class="divReportName" id="divChargesSummary" runat="server" style="display: none;">
                        Charges Summary
                    </div>
                    <div class="divReportName" id="divChargesDetail" runat="server" style="display: none;">
                        Charges Detail
                    </div>
                    <div class="divReportName" id="divPaymentByProcedure" runat="server" style="display: none;">
                        Payment By Procedure
                    </div>
                    <div class="divReportName" id="divItemizationOfCharges" runat="server" style="display: none;">
                        Itemization Of Charges
                    </div>
                    <div class="divReportName" id="divSettledChargesSummary" runat="server" style="display: none;">
                    ...
                    <div id="divReportServiceProvider" runat="server" style="display: none; padding-bottom: 45px;">
                        <div class="divBranchName" style="">
                                                    ...
                                                    <ItemTemplate>
                                                        <li style="float: left; width: 100%;">
                                                            <label name='<%#Eval("PracticeStaffId") %>' onclick="Report_ClickMultiCheckBox(this);" style="float: left;">
                                                                ...
                                                                <input type="hidden" value='<%#Eval("PracticeStaffId") %>' class="PatientId" />
                                                            </label>
                                                        </li>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                    ...
                    <div id="divPatientSarch" runat="server" style="display: none; padding-bottom: 45px;">
                        <div class="divBranchName" style="">
                            ...
                            <div class="clsPatientId BranceInput">
                                ...
                                <img src="../../Images/arrow_down5.PNG" style="width: 11px; margin-top: 11px; margin-left: -15px; position: absolute;" onclick="searchPatient(this)" />
                                                    ...
                                                    <ItemTemplate>
                                                        <li style="float: left; width: 100%;">
                                                            <label name='<%#Eval("PatientId") %>' onclick="Report_ClickMultiCheckBox(this);" style="float: left;">
                                                                ...
                                                                <input type="hidden" value='<%#Eval("PatientId") %>' class="PatientId" />
                                                            </label>
                                                        </li>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                    ...
                    <%--  --%>
                    <div id="divReportDiagnosis" runat="server" style="display: none; padding-bottom: 45px;">
                            ...
                            <div class="clsDiagnosis BranceInput" id="divDiagnosis" style="">
                                <table>
                                    <tr>
                                        ...
                                        <td class="leftTd">
                                            <input type="text" id="txtIcdDesc1" runat="server" class="upperCase" onkeyup="searchIcDs('D','', this.value, this, event);" onchange="PopulateICD9Code(this, 'txtIcdCode1');" style="width: 85%; float: left;" />
                    ...
                    <div id="divAssignedTo" runat="server" style="display: none; padding-bottom: 45px;">
                        <div class="divBranchName" style="">
                    ...
                    <div id="divGender" runat="server" style="display: none; padding-bottom: 45px">
                    ...
                    <div id="divDate" runat="server" style="display: none; padding-bottom: 45px">

                        <div class="divBranchName" style="">
                            <span class="spnBranchName" style="">Date:</span>
                            <div class="clsPostDate BranceInput " id="divddlDate" onchange="EnableDisableDates();">
                                <asp:DropDownList ID="ddlDate" CssClass="ddlDate ddlPostType" runat="server" Style="">
                                                    ...
                                                    <ItemTemplate>
                                                        <li style="float: left; width: 100%;">
                                                            <label name='<%#Eval("PracticeLocationsId") %>' onclick="Report_ClickMultiCheckBox(this);" style="float: left;">
                                                                <input type="checkbox" class="chkPracticeLocation chk-multi-checkboxes" checked="checked" onclick="ReportAlert(this)" />
                                                                <span><%#Eval("Name") %></span>
                                                                <input type="hidden" value='<%#Eval("PracticeLocationsId") %>' class="PatientId" />
                                                            </label>
                                                        </li>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                    ...
                    <div id="divReportPayerScenario" runat="server" style="display: none; padding-bottom: 45px">
                        <div class="divBranchName" style="">
                                                    ...
                                                    <ItemTemplate>
                                                        <li style="float: left; width: 100%;">
                                                            <label name='<%#Eval("InsuranceId") %>' onclick="Report_ClickMultiCheckBox(this);" style="float: left;">
                                                                <input type="checkbox" class="chkPayerScenario chk-multi-checkboxes" checked="checked" onclick="ReportAlert(this)" />
                                                                <span><%#Eval("Name") %></span>
                            ...
                            <div style="width: 100%">
                                <div id="From" style="width: 50%; float: left">
                                    ...
                                    <span style="width: 80%; float: right">
                                        <asp:TextBox runat="server" ID="txtBillDateFrom" CssClass="required" Style="width: 135px !important" Enabled="false"></asp:TextBox></span>
                                </div>
                                <div id="to" style="width: 50%; float: right">
                                    <span style="width: 20%; float: left">To:</span>
                                    <span style="width: 80%; float: right">
                                        <asp:TextBox runat="server" ID="txtBillDateTo" CssClass="required" Style="width: 135px !important" Enabled="false"></asp:TextBox></span>
                                </div>
                            </div>
                ...
                <%--    <div id="divBillDates" runat="server" style="display:none; border-bottom:1px solid #ccc; height:35px;">
                 <div class="divBranchName" style="margin-top: 3%;">
                       <span class="spnBranchName" style="float:left; margin-left:0%;">Dates:</span>
                     <div class="div-dates">
                        <table id="tblBillDates" style="width: 81%; table-layout: auto; margin-top: -2%; margin-left: 17% !important;">
                           <tr>
                              <td style="width: 45px; text-align: right;">
                                  <span>From:</span>
                              </td>
                              <td style="width: 120px;">
                                  <asp:TextBox runat="server" ID="txtBillDateFrom" CssClass="required"></asp:TextBox>
                              </td>
                              <td style="width: 40px; text-align: right;" id="Td1" runat="server">
                                  <span">To:</span>
                              </td>
                              <td style="width: 120px;" id="td2" runat="server">
                                  <asp:TextBox runat="server" ID="txtBillDateTo" CssClass="required"></asp:TextBox>
                              </td>
                          </tr>
                      </table>
                                    </div>
            ...
            <%-- <div class="divTimeSpan" id="divTimeSpan" runat="server" style="display:none;">
                <span class="spnTimeSpan" id="AgencyReportFilterBox_tdlblTimeSpam">Time Span:</span>
                <div class="divTable" id="divReportTimeSpan">
                    <div class="divTableBody">
                           <div class="divTableRow" id="divRowRdo" runat="server" >
                                <div class="divTableCell divRightBorder" id="divCellBeginning" runat="server">
                                        <asp:RadioButton runat="server" ID="rbReportTimeSpanFromTheBeginning" Text="From the Beginning" Checked="true" CssClass="Beginning" GroupName="rbReportTimeSpan" onclick="EnableDates(false);" />
                                        <asp:RadioButton runat="server" ID="rbReportTimeSpanLastMonth" Text="Last Month" CssClass="LastMonth" GroupName="rbReportTimeSpan" onclick="EnableDates(false);" />
                                        <br />
                                        <br />
                                        <asp:RadioButton runat="server" ID="rbReportTimeSpanMonthToDate" Text="Month to Date" CssClass="MonthToDate" GroupName="rbReportTimeSpan" onclick="EnableDates(false);" />
                                        <asp:RadioButton runat="server" ID="rbReportTimeSpanYearToDate" Text="Year to Date" CssClass="YearToDate" GroupName="rbReportTimeSpan" onclick="EnableDates(false);" />
                                </div>
                    ...
                    <div class="row" id="divRowRdo" runat="server">
                        <div class="col40" id="divCellBeginning" style="width: 40%" runat="server">
                            <ul style="margin-top: 8px;">
                                <li class="radio_li">
                                    <asp:RadioButton runat="server" ID="rbReportTimeSpanToday" Text="Today" Checked="true" CssClass="Today" GroupName="rbReportTimeSpan" onclick="EnableDates(false);" /></li>
                                <li class="radio_li">
                                    <asp:RadioButton runat="server" ID="rbReportTimeSpanFromTheBeginning" Text="From the Beginning" CssClass="Beginning" GroupName="rbReportTimeSpan" onclick="EnableDates(false);" /></li>
                                <li class="radio_li">
                        ...
                        <div class="col60" style="width: 60%; float: left; padding-right: 10px; box-sizing: border-box;">
                            <asp:RadioButton runat="server" ID="rbReportTimeSpanSpecificDates" Text="Select Date" CssClass="SpecificDates" GroupName="rbReportTimeSpan" onclick="EnableDates(true);" Style="font-weight: bold;" />
                            <br />
                            <div class="">
                                <table id="timeDurationAgencyReportFilterBox" style="width: 325px; table-layout: auto; margin-top: -2%;">
