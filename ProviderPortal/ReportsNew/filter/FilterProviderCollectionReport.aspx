<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FilterProviderCollectionReport.aspx.cs" Inherits="ProviderPortal_ReportsNew_filter_FilterProviderCollectionReport" %>
        ...
        <div>
            ...
            <div class="GridReports" id="ProviderCollectionPrint" style="overflow-y: scroll; height: 430px;">
                <table class="fixTable">
                    <thead>
                        <tr>
                            <th style="text-align: center !important; background-color: rgb(79, 175, 216); position: relative; top: 0px;">#</th>
