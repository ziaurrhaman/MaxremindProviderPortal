...
using System.Data;
public partial class EMR_ReportsNew_filter_FilterPayerMixSummaryReport : System.Web.UI.Page
{
    string _DateFrom = "";
    string _DateTo = "";
    string _DateType = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string LocationId = Request.Form["Location"];
        ...
        DataSet dsReportData = objPatientReportsDB.GetPayerMixSummary(PracticeId, Rows, PageNumber, Insurance, IsImportedDataOnly);
