...
public partial class ProviderPortal_Reports_ProvidersReport : System.Web.UI.Page
{
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        long PracticeId = Profile.PracticeId;
        ReportsPatientDB objPatientReportsDB = new ReportsPatientDB();
        DataSet dsReportData = objPatientReportsDB.GetProviders(PracticeId, Rows, 0, "LastName ASC");
        rptProviders.DataSource = dsReportData.Tables[0];
        rptProviders.DataBind();
        Response.Clear();
        Response.Buffer = true;
        Response.AddHeader("content-disposition", "attachment;filename=Providers.xls");
        Response.Charset = "";
        Response.ContentType = "application/vnd.ms-excel";
        StringWriter sw = new StringWriter();
        HtmlTextWriter hw = new HtmlTextWriter(sw);
        rptProviders.RenderControl(hw);
    ...
    public void repeaterExportToPDF(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Providers.pdf");
    ...
    public void repeaterExportToWord(object sender, EventArgs e)
    {
        ...
        Response.Clear();
        Response.AddHeader("content-disposition", "attachment;filename=Providers.doc");
        Response.Charset = "";
        Response.Cache.SetCacheability(HttpCacheability.NoCache);
        Response.ContentType = "application/vnd.word";
        System.IO.StringWriter stringWrite = new System.IO.StringWriter();
        System.Web.UI.HtmlTextWriter htmlWrite = new HtmlTextWriter(stringWrite);
        rptProviders.RenderControl(htmlWrite);
