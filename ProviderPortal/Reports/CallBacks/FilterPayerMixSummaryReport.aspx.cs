...
public partial class ProviderPortal_Reports_CallBacks_FilterPayerMixSummaryReport : System.Web.UI.Page
{
    string _DateFrom = "";
    string _DateTo = "";
    string _TimeSpan = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet dsReportData = objPatientReportsDB.GetPayerMixSummary(PracticeId, Rows, PageNumber, "");
