...
public partial class ProviderPortal_Reports_CallBacks_FilterInsuranceCollectionDetailReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet dsReportData = objPatientReportsDB.GetInsuranceCollectionDetail(PracticeId, Rows, PageNumber, SortBy, AgingType, AgingDate, PracticeLocationId, ProviderId, PayerId, ClaimStatus);
