...
public partial class ProviderPortal_Reports_PaymentsDetailReport : System.Web.UI.Page
{
    string _DateFrom = "";
    string _DateTo = "";
    string _TimeSpan = "";
    ...
    private void LoadReport()
    {
        ...
        DataSet dsReportData = objPatientReportsDB.GetPaymentsDetail(PracticeId, 10, 0, "PaymentId desc", _DateFrom, _DateTo);
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        _DateFrom = Request.Form["DateFrom"];
        _DateTo = Request.Form["DateTo"];
        DataSet dsReportData = objPatientReportsDB.GetPaymentsDetail(PracticeId, Rows, 0, "PaymentId ASC", _DateFrom, _DateTo);
        rptPaymentsDetail.DataSource = dsReportData.Tables[0];
        rptPaymentsDetail.DataBind();
        Response.Clear();
        Response.Buffer = true;
        Response.AddHeader("content-disposition", "attachment;filename=Payment-Detail.xls");
        Response.Charset = "";
        Response.ContentType = "application/vnd.ms-excel";
        StringWriter sw = new StringWriter();
        HtmlTextWriter hw = new HtmlTextWriter(sw);
        rptPaymentsDetail.RenderControl(hw);
    ...
    public void repeaterExportToPDF(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Payment-Detail.pdf");
    ...
    public void repeaterExportToWord(object sender, EventArgs e)
    {
        ...
        Response.Clear();
        Response.AddHeader("content-disposition", "attachment;filename=Payment-Detail.doc");
        Response.Charset = "";
        Response.Cache.SetCacheability(HttpCacheability.NoCache);
        Response.ContentType = "application/vnd.word";
        System.IO.StringWriter stringWrite = new System.IO.StringWriter();
        System.Web.UI.HtmlTextWriter htmlWrite = new HtmlTextWriter(stringWrite);
        rptPaymentsDetail.RenderControl(htmlWrite);
