...
public partial class ProviderPortal_Reports_EncounterSummaryReport : System.Web.UI.Page
{
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        hdnDateType.Value = Request.Form["DateType"];
        DataSet dsReportData = objPatientReportsDB.GetEncounterSummary(PracticeId, Rows, 0, "PostDate ASC", DateType, SubmissionStatusId, _DateFrom, _DateTo, ProviderId, PracticeLocationId, PayerId);
        rptDenialsDetail.DataSource = dsReportData.Tables[0];
        rptDenialsDetail.DataBind();
        Response.Clear();
    ...
    public void repeaterExportToPDF(object sender, EventArgs e)
    {
        ...
        string PayerId = Request.Form["PayerId"];
        string SubmissionStatusId = Request.Form["SubmissionStatusId"];
        DataSet dsReportData = objPatientReportsDB.GetEncounterSummary(PracticeId, Rows, 0, "Encounters ASC", DateType, SubmissionStatusId, _DateFrom, _DateTo, ProviderId, PracticeLocationId, PayerId);
        ...
        table.AddCell(new Phrase("Total Balance", font5));
