<%@ Page Title="" Language="C#" MasterPageFile="~/ProviderPortal/BillingMaster.master" AutoEventWireup="true" CodeFile="PatientTransactionsSummaryReport.aspx.cs" Inherits="ProviderPortal_Reports_PatientTransactionsSummaryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="Widget" style="margin-top: 10px;">
       <%-- <div class="WidgetTitle">
            <span id="spnTitle" style="font-size: 15px;">Patient Transactions Summary</span>
        </div>--%>
        <div class="reportsCriteriabar" style="background:#dfe3e5;height: 36px;">
            <div class="report-criteria-wraper" style="width:50% !important;font-weight: bold;">
              ...
              <div class="report-criteria-wraper" style="width:50% !important; float:right;">
                <a href="javascript:void(0);" class="report-criteria-link" onclick="OpenPatientFilterDialog('PTS');" style="float: right;font-weight: bold; margin-right:3%; margin-top:-2%;">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="asc" onclick="SortReportList(this,'Receipt');">
                                                        <span class="report-column-title">Receipt</span><span></span>
                                                    </th>
                                                  <%--  <th class="asc" onclick="SortReportList(this,'Refunds');">
                                                        <span class="report-column-title">Refunds</span><span></span>
                                                    </th>--%>
                                                    ...
                                                    <th class="asc" onclick="SortReportList(this,'InsBalance');">
                                                        <span class="report-column-title">Insurance Balance</span><span></span>
                                                    </th>
    ...
    <script type="text/javascript">
        ...
        function FilterReportList(pageNumber, paging) {
            ...
            var actionPage = "FilterPatientTransactionsSummaryReport.aspx";
