...
public partial class ProviderPortal_Reports_DenialsDetailReport : System.Web.UI.Page
{
    ...
    private void LoadReport()
    {
        ...
        DataSet dsReportData = objPatientReportsDB.GetDenialsDetail(PracticeId, 10, 0, "ClaimId DESC", DateType, _DateFrom, _DateTo, ProviderId, PracticeLocationId, Insurance, AdjustmentCode);
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        string AdjustmentCode = Request.Form["AdjustmentCode"];
        hdnDateType.Value = Request.Form["DateType"];
        DataSet dsReportData = objPatientReportsDB.GetDenialsDetail(PracticeId, Rows, 0, "ClaimId ASC", DateType, _DateFrom, _DateTo, ProviderId, PracticeLocationId, Insurance, AdjustmentCode);
        rptDenialsDetail.DataSource = dsReportData.Tables[0];
        rptDenialsDetail.DataBind();
        Response.Clear();
        Response.Buffer = true;
        Response.AddHeader("content-disposition", "attachment;filename=Denials-Detail.xls");
        Response.Charset = "";
    ...
    public void repeaterExportToPDF(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Denials-Detail..pdf");
    ...
    public void repeaterExportToWord(object sender, EventArgs e)
    {
        ...
        Response.Clear();
        Response.AddHeader("content-disposition", "attachment;filename=Denials-Detail.doc");
        Response.Charset = "";
        Response.Cache.SetCacheability(HttpCacheability.NoCache);
