...
public partial class ProviderPortal_Reports_PatientTransactionsSummaryReport : System.Web.UI.Page
{
    string _DateFrom = "";
    string _DateTo = "";
    string _TimeSpan = "";
    ...
    private void LoadReport()
    {
        ...
        DataSet dsReportData = objPatientReportsDB.PatientTransactionsSummary(PracticeId, 10, 0, "PatientId ASC", _DateFrom, _DateTo);
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        _DateFrom = Request.Form["DateFrom"];
        _DateTo = Request.Form["DateTo"];
        DataSet dsReportData = objPatientReportsDB.PatientTransactionsSummary(PracticeId, Rows, 0, "PatientId ASC", _DateFrom, _DateTo);
        rptPatientTransactionsSummary.DataSource = dsReportData.Tables[0];
        rptPatientTransactionsSummary.DataBind();
        Response.Clear();
        ...
        rptPatientTransactionsSummary.RenderControl(hw);
    ...
    public void repeaterExportToWord(object sender, EventArgs e)
    {
        ...
        rptPatientTransactionsSummary.RenderControl(htmlWrite);
