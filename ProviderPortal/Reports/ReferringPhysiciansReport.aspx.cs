...
public partial class ProviderPortal_Reports_ReferringPhysiciansReport : System.Web.UI.Page
{
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        long PracticeId = Profile.PracticeId;
        ReportsPatientDB objPatientReportsDB = new ReportsPatientDB();
        DataSet dsReportData = objPatientReportsDB.GetReferringPhysicians(PracticeId, Rows, 0, "LastName ASC");
        rptReferringPhysicians.DataSource = dsReportData.Tables[0];
        rptReferringPhysicians.DataBind();
        Response.Clear();
        Response.Buffer = true;
        Response.AddHeader("content-disposition", "attachment;filename=Referring-Physicians.xls");
        Response.Charset = "";
        Response.ContentType = "application/vnd.ms-excel";
        StringWriter sw = new StringWriter();
        HtmlTextWriter hw = new HtmlTextWriter(sw);
        rptReferringPhysicians.RenderControl(hw);
    ...
    public void repeaterExportToPDF(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Referring-Physicians.pdf");
    ...
    public void repeaterExportToWord(object sender, EventArgs e)
    {
        ...
        Response.Clear();
        Response.AddHeader("content-disposition", "attachment;filename=Referring-Physicians.doc");
        Response.Charset = "";
        Response.Cache.SetCacheability(HttpCacheability.NoCache);
        Response.ContentType = "application/vnd.word";
        System.IO.StringWriter stringWrite = new System.IO.StringWriter();
        System.Web.UI.HtmlTextWriter htmlWrite = new HtmlTextWriter(stringWrite);
        rptReferringPhysicians.RenderControl(htmlWrite);
