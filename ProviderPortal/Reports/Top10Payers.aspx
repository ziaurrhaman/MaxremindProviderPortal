<%@ Page Title="" Language="C#" MasterPageFile="~/ProviderPortal/BillingMaster.master" AutoEventWireup="true" CodeFile="Top10Payers.aspx.cs" Inherits="EMR_Reports_Top10Payers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ###StartReport###
        ...
        <%--<div class="ReportHeader WidgetTitle">
            <span id="spnTitle" style="font-size: 15px;">Top 10 Payers</span>
        </div>--%>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th id="PatientId" class="asc"  onclick="filterTherapyTask(this,'PatientId');">
                                                        <span class="report-column-title">Payer Name</span><span class="filterIcon asc"></span>
                                                    </th>
                                                    <th id="PatientName" style="width:10%;" onclick="filterTherapyTask(this,'PatientName');">
