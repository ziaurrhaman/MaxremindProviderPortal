...
public partial class EMR_Reports_Top10Payers : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        if (exportTo == "Excel")
        {
            obj.ExportToExcel(ref html, "Top 10 Payers");
        }
        else if (exportTo == "PDF")
        {
            obj.ExportToPDF(ref html, "Top 10 Payers");
        }
        else if (exportTo == "Word")
        {
            ExportToWord(html, "Top 10 Payers");
        }
    }
