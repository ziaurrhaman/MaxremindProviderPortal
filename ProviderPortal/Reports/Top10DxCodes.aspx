<%@ Page Title="" Language="C#" MasterPageFile="~/ProviderPortal/BillingMaster.master" AutoEventWireup="true" CodeFile="Top10DxCodes.aspx.cs" Inherits="EMR_Reports_Top10DxCodes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <%--   <div class="ReportHeader WidgetTitle">
            <span id="spnTitle" style="font-size: 15px;">Top 10 Diagnosis</span>
        </div>--%>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th id="">
                                                      ...
                                                      <th id="" style=" text-align:left;">
                                                        <span class="report-column-title">Official Name</span> <span></span>
                                                    </th>                                                   
                                                       <th id="" class="asc" style="width:10%; text-align:center">
                                                        <span class="report-column-title">No of Times Used</span><span class=""></span>
                                                    </th>
