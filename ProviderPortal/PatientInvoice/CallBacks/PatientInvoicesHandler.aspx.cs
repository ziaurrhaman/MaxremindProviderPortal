...
public partial class ProviderPortal_PatientInvoice_CallBacks_PatientInvoicesHandler : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //{ 
        //    PatientInvoiceDB objPatientInvoiceDb = new PatientInvoiceDB();
        //    DataSet dsPendingSubmissions = objPatientInvoiceDb.GetPendingSubmissions1(Convert.ToInt64(Profile.PracticeId), Rows, pageNumber, PayerId, PatientName, lastInvoiceSubmitted, totalPendingAmount, null, null, null, null, type);
