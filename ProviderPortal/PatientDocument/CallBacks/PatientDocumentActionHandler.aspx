<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatientDocumentActionHandler.aspx.cs" Inherits="ProviderPortal_PatientDocument_CallBacks_PatientDocumentActionHandler" %>
...
<body>
    ...
    <asp:Literal runat="server" ID="ltrTotalRows" Text="0"></asp:Literal>
