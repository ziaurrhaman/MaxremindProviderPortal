<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddEditPatientDocumentHandler.aspx.cs" Inherits="ProviderPortal_PatientDocument_CallBacks_AddEditPatientDocumentHandler" %>
    ...
    <asp:Repeater ID="rptPatientDocuments" runat="server">
        <ItemTemplate>
            <tr>
                ...
                <td onclick="EditPatientDocument(this)" style="cursor: pointer;">
