<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppointmentsActionHandler.aspx.cs" Inherits="ProviderPortal_Scheduler_CallBacks_AppointmentsActionHandler" %>
...
<body>
    ...
    ###EndCheckedInPatients###
    ###StartStatusColor###
    <asp:Literal runat="server" ID="ltrStatusColor"></asp:Literal>
    ###EndStatusColor###
    ###StartAppointmentsId###
    <asp:Literal runat="server" ID="ltrAppointmentsId"></asp:Literal>
    ###EndAppointmentsId###
    ###StartStatusBackColor###
    <asp:Literal runat="server" ID="ltrStatusBackColor"></asp:Literal>
    ###EndStatusBackColor###
    ###StartReasonBackColor###
    <asp:Literal runat="server" ID="ltrReasonBackColor"></asp:Literal>
    ###EndReasonBackColor###
    </div>
    </form>
</body>
