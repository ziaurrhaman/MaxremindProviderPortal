...
public partial class ProviderPortal_Claim_CallBacks_PayerCalimDistributionHandler : System.Web.UI.Page
{
    string DateCriteria = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
   {
        ...
        string ClaimId = null; string DOS = null;
        ...
        string PayerName =Request.Form["PayerName"].ToString();
        if (Datetype == "Dos")
        {
            DOSDate();
        }
       ...
       DataSet ClaimSubmissionChar = db.PayerCLAIMDistributionPIECHARTDetail(Convert.ToInt64(PracticeId), Convert.ToInt32(Rows), Convert.ToInt32(PageNumber), "ClaimId asc", Location, StartDate, EndDate, Provider, PayerName, "", PatientName, ClaimId, DOS, "", "", PostStartDate, PostEndDate, postDate);
