...
public partial class ProviderPortal_Claim_CallBacks_ClaimSubmissionStatusAgingHandler : System.Web.UI.Page
{
    string DateCriteria = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string ColumnValue = Request.Form["Aging"].ToString();
        string Aging = null;
        if (ColumnValue == "1")
        {
            Aging = "0 to Seven";
        ...
        {
            Aging = "Eight to Fifteen";
        }
        else if (ColumnValue == "3")
        {
            Aging = "Sixteen to Twenty one";
        }
        else
        {
            Aging = "Above Twenty one";
        }
        ...
        DataSet ClaimSubmissionChar = db.CLAIMSUBMISSIONSTATUSAgingChartDetail(Convert.ToInt64(PracticeId), Convert.ToInt32(Rows),Convert.ToInt32(PageNumber), "ClaimId asc", Location, StartDate, EndDate, Provider, SubmissionStatus, "", "", "", "", "", "", Aging, PostStartDate, PostEndDate, "");
        rptClaimSS.DataSource = ClaimSubmissionChar;
           rptClaimSS.DataBind();
