<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayerCalimDistribution.aspx.cs" Inherits="ProviderPortal_Claim_PayerCalimDistribution" %>
                    ...
                    <div class="pagerReport">
                        <div class="PageEntries">
                            <span style="float: left; margin-left: 5px;">Show&nbsp;</span><span style="float: left;">
                                <select id="ddlPagingClaimChecks" style="margin-top: 5px;" onchange="RowsChange('FilterPayerClaimDistribution');">
                        ...
                        <div class="report-tools">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span onclick="  setrowid();   FilterPayerClaimDistribution(0,true);" id="refreshbtn">
                          ...
                          <div id="Filter Criteria">
                            <span style="margin-left:39%; color:#393333; cursor:pointer" onclick="FilterCriteriaCharts('PCD');">  <img src="../../Images/edit.png" /> Filter Criteria </span>
                        </div>                       
                    </div>
                </div>
  ...
  <asp:HiddenField runat="server" ID="hdnTotalRows" />
    ...
    <script type="text/javascript">
        function JumpToPageNo(event) {
            ...
            pageNumber--;
            FilterPayerClaimDistribution(pageNumber);
        }
