            ...
            _refreshEventDetails: function (calEvent, $calEvent) {
                ...
                if (!calEvent.Disabled) {
                    if (!this.options.readonly) {
                        ...
                        suffix_title += calEvent.status;
                        suffix_title += '</span>';
                        suffix_title += '<input type="hidden" class="hdnStatusId" value="' + calEvent.statusId + '" />';
                        suffix_title += '</div>';
                    }
                }
