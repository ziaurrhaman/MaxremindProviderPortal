...
var Dynamsoft = (function () {
	...
	var ua = (navigator.userAgent.toLowerCase()),
		...
		DWTProduct : {
			...
			_strVersionCode: '9,2', 				// The version of DWT. ActiveX will use this to determin if it is necessary to upgrade the client. Use ',' to separate the numbers. 		
...
(function(D) {
    ...
    var o = document.getElementById(this._strDWTNonInstallInnerContainerID);
        ...
        var strObjString = ["<div style='display: block; border:solid black 1px; text-align:center; width:96px;",
			"px;height:362px'>",
    ...
    SWebTwain.prototype._createNonInstallDivPlugin = function() {
        ...
        if (Dynamsoft.Env._bInIE) {
            ...
            var strObjString = ["<div style='display: block; border:solid black 1px; text-align:center; width:96px;",
			    "px;height:362px",
				"; position: absolute; right: 0; background: #fff; height: 215px;'>",
				"<ul style='padding-top:100px;'>",
				"<li>The Component is not installed</li>",
				"<li>You need to download and install the plug-in.</li>",
				"<li>Please click the below link to download it.</li>",
//				"<li>After the installation, please RESTART your browser.</li>",
				"<li><a href='",
				_RooTPath + "Resources/DynamicWebTWAINPlugIn.msi",
				"'>Download</a></li>",
				"</ul></div>"].join('');
        }
