        ...
        function () {
            ...
            show =
              function () {
                  ...
                  if (settings.window.expandable) {
                      $(document.body).children('div.jPicker.Container').css({ zIndex: 99999999 });
                      container.css({ zIndex: 99999999 });
                  }
            ...
            hide =
              function () {
                  var removeIFrame = function () {
                      if (settings.window.expandable) container.css({ zIndex: 99999999 });
                      if (!settings.window.expandable || $.support.boxModel) return;
...
$.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
            clientPath: _RooTPath + 'Images/', /* Path to image files */
            colorMap:
          {
              width: 256,
              height: 256,
